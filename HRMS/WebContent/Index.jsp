  ...
  <body background="red">
    <div class="login-box">
      ...
      <div class="login-box-body">
		...
		<%
		String logout_msg=(String)request.getAttribute("success");  
		if(logout_msg!=null)
		out.println("<font color=green>"+logout_msg+"</font>"); %>
		</p>
        ...
        <a href="Registration.jsp" class="text-center">Register a new membership</a>
      </div><!-- /.login-box-body -->
    </div><!-- /.login-box -->
    <!-- jQuery 2.1.3 -->
